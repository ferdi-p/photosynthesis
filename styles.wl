...
colorPoints2=ColorData[116][3](*Darker@Gray*);
...
makeOneSimulationSteadyStatePlot[pars_,focalpar_,focalparrange_,quant_,tend_,options_]:=ListPlot[
Table[
Module[
...
AxesOrigin->({0,0}/.pars),
PlotLabel->(focalpar/.names),
FrameLabel->{{quant/.units,None},
{focalpar/.units,None}},
Joined->True,
PlotStyle->thickness,
